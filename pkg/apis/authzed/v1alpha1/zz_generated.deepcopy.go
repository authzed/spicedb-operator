...
func (in *ClusterCredentials) DeepCopyInto(out *ClusterCredentials) {
	*out = *in
	if in.DatastoreURI != nil {
		in, out := &in.DatastoreURI, &out.DatastoreURI
	...
	if in.MigrationSecrets != nil {
		in, out := &in.MigrationSecrets, &out.MigrationSecrets
		*out = new(CredentialRef)
		**out = **in
	}
	if in.MigrationDatastoreURI != nil {
		in, out := &in.MigrationDatastoreURI, &out.MigrationDatastoreURI
		*out = new(CredentialRef)
		**out = **in
	}
}

...
func postgresChannel() updates.Channel {
	releases := []updates.State{
		{ID: "v1.33.0", Tag: "v1.33.0", Migration: "add-rel-by-alive-resource-relation-subject"},
...
func crdbChannel() updates.Channel {
	releases := []updates.State{
		{ID: "v1.33.0", Tag: "v1.33.0", Migration: "remove-stats-table"},
...
func mysqlChannel() updates.Channel {
	releases := []updates.State{
		{ID: "v1.33.0", Tag: "v1.33.0", Migration: "watch_api_relation_tuple_index"},
...
func spannerChannel() updates.Channel {
	releases := []updates.State{
		{ID: "v1.33.0", Tag: "v1.33.0", Migration: "delete-older-changestreams"},

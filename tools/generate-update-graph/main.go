...
func postgresChannel() updates.Channel {
	releases := []updates.State{
		{ID: "v1.28.0", Tag: "v1.28.0", Migration: "add-rel-by-alive-resource-relation-subject"},
		{ID: "v1.27.0", Tag: "v1.27.0", Migration: "add-rel-by-alive-resource-relation-subject"},
...
func crdbChannel() updates.Channel {
	releases := []updates.State{
		{ID: "v1.28.0", Tag: "v1.28.0", Migration: "add-caveats"},
		{ID: "v1.27.0", Tag: "v1.27.0", Migration: "add-caveats"},
...
func mysqlChannel() updates.Channel {
	releases := []updates.State{
		{ID: "v1.28.0", Tag: "v1.28.0", Migration: "watch_api_relation_tuple_index"},
		{ID: "v1.27.0", Tag: "v1.27.0", Migration: "watch_api_relation_tuple_index"},
...
func spannerChannel() updates.Channel {
	releases := []updates.State{
		{ID: "v1.28.0", Tag: "v1.28.0", Migration: "register-schema-change-stream"},
		{ID: "v1.27.0", Tag: "v1.27.0", Migration: "register-schema-change-stream"},
...
func memoryChannel() updates.Channel {
	releases := []updates.State{
		{ID: "v1.28.0", Tag: "v1.28.0"},
		{ID: "v1.27.0", Tag: "v1.27.0"},
